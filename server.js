...
function normalizeLeadRecord(lead, index = 0, updates = {}) {
  ...
  return {
    ...
    appointmentStart: String(valueFor('appointmentStart')),
    appointmentEnd: String(valueFor('appointmentEnd')),
    appointmentType: String(valueFor('appointmentType')),
    jobStartAt: String(valueFor('jobStartAt')),
    jobEndAt: String(valueFor('jobEndAt')),
    invoiceNumber: String(valueFor('invoiceNumber')),
    invoiceStatus: String(valueFor('invoiceStatus')),
    invoiceAmount: String(valueFor('invoiceAmount')),
    invoiceDueDate: String(valueFor('invoiceDueDate')),
    invoiceSentAt: String(valueFor('invoiceSentAt')),
    depositPaidAt: String(valueFor('depositPaidAt')),
    paidAt: String(valueFor('paidAt')),
    completedAt: String(valueFor('completedAt')),
