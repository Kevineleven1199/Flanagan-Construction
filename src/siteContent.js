...
export function normalizeLead(lead = {}, index = 0) {
  ...
  return {
    ...
    serviceRoute: lead.serviceRoute || '',
    ...
    appointmentEnd: lead.appointmentEnd || '',
    appointmentType: lead.appointmentType || '',
    jobStartAt: lead.jobStartAt || '',
    jobEndAt: lead.jobEndAt || '',
    invoiceNumber: lead.invoiceNumber || '',
    invoiceStatus: lead.invoiceStatus || '',
    invoiceAmount: lead.invoiceAmount || '',
    invoiceDueDate: lead.invoiceDueDate || '',
    invoiceSentAt: lead.invoiceSentAt || '',
    depositPaidAt: lead.depositPaidAt || '',
    paidAt: lead.paidAt || '',
